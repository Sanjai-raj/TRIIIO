...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar Drawer */}
            <aside className={`main-sidebar bg-[#008B9E] shadow-2xl md:shadow-none w-[260px] h-full text-sm fixed left-0 top-0 bottom-0 md:static flex flex-col z-20 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
                {/* Brand Logo */}
