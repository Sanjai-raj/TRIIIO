                ...
                <div className="w-full relative overflow-hidden rounded-[32px] shadow-xl bg-black">
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-8 flex flex-col items-start">
                        ...
                        <motion.h1
                            ...
                            className="text-3xl font-black leading-tight text-white max-w-[200px] mb-2 font-serif tracking-tight"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-gray-200 text-sm font-medium max-w-[240px] mb-8 opacity-90"
                        >
